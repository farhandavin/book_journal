<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center p-6 bg-gray-50">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-4xl flex flex-col md:flex-row">
            ...
            {{-- Right Side: Banner (Green) --}}
            <div class="w-full md:w-1/2 bg-green-600 p-12 text-white flex flex-col justify-center items-center text-center">
                <h2 class="text-3xl font-bold mb-4 text-white">Sudah Punya Akun?</h2>
                <p class="mb-8 text-green-100 text-lg">
                    Jika Anda sudah memiliki akun, silakan masuk untuk mengakses jurnal buku Anda.
                </p>
                <a href="{{ route('login') }}" class="bg-white text-green-600 font-bold py-3 px-8 rounded-lg shadow-lg hover:bg-gray-50 hover:scale-105 transition-all duration-200">
                    Login Sekarang!
                </a>
            </div>
        </div>
